...
# can in ooRexx instead of having to do all that math? So, I threw the passed
# number into an array and just dealt with each integer based on where it was in
# the array.
